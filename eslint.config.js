...
export default [
  ...
  },
  {
    ...
    files: ["public/board-render-3d.js", "public/model-normalize.js", "public/tile-placer/*.js"],
    languageOptions: {
      ecmaVersion: "latest",
      sourceType: "module",
  ...
  },
  {
    ...
    files: ["public/**/*.js"],
    ignores: ["public/board-render-3d.js", "public/model-normalize.js", "public/tile-placer/*.js"],
    languageOptions: {
      ecmaVersion: "latest",
      sourceType: "script",
      globals: {
